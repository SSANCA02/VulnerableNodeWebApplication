...
<!-- Services section -->
	<section id="what-we-do">
		<div class="container-fluid">
			<h2 class="section-title mb-2 h1"> - Vulnerable Node Web Application -</h2>
			<p class="text-center text-muted mt-4 ml-5 mr-5 h5">This application has been created to be vulnerable on purpose. Feel free to experiment with it so you can learn the most popular vulnerabilities in web applications. This study was used to see the efficiency of free scanning tools. Among the vulnerabilities you can find are the following: </p>
			<div class="row mt-5">
...
#what-we-do .card .card-block a{
	color:  rgba(245, 155, 38, 0.959) !important;
	font-weight:700;
